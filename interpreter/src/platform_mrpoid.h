...
#define GLOBAL_TABLE_SIZE 200                // 全局变量表 
...
#define STRUCT_TABLE_SIZE 30                // 结构/联合成员表的大小（可扩展）

#define HEAP_SIZE (500*1024)               // 堆和堆栈空间 XL风的影子修改
...
#define HEAP_SIZE (200*1024)               // 堆和堆栈空间
*/
